...
<div class="container">
	...
	<div class="sixteen columns">
		...
		<p>Click Submit to view/edit/delete your jobs.</p>
		<form action="editjobs.php" method="post" class="search">
			<input type="submit" name="listjobs" />
		</form>
		...
		<table class="manage-table responsive-table">
			...
			<tr>
				...
				<th><i class="fa fa-calendar"></i> Salary</th>
				<th><i class="fa fa-calendar"></i> State</th>
			...
			if (isset($_POST['listjobs']))
			{
				...
				$sql = "select * FROM Jobs where JobTitle LIKE '%".$Search."%'";
				$result = mysqli_query($con, $sql) or die(mysqli_error($con)); 
				
				while ($row = $result->fetch_object()) {
					
					print '<tr>';
					print '<td>'.$row->JobTitle ."</td><td>".$row->Salary ."</td><td>".$row->City ."</td>";
					print '<td class="centered"><a href="manage-applications.html" class="button">Show</a></td>';
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td class="centered"><a href="manage-applications.html" class="button">Show</a></td>
				<td class="action">
					<a href="#"><i class="fa fa-pencil"></i> Edit</a>
					<a href="#"><i class="fa  fa-check "></i> Mark Filled</a>
					<a href="#" class="delete"><i class="fa fa-remove"></i> Delete</a>
